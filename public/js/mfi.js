...
function dataTablefn() {
  ...
  $(function () {
    var numberOfItems = $("#mfiTable tbody tr").length;
    var limitPerPage = 10;
    var totalPages = Math.ceil(numberOfItems / limitPerPage);
    var paginationSize = 5;
    var currentPage;
    var totalRows = $("#mfiTable tbody tr").length;
    ...
    function showPage(whichPage) {
      ...
      var maxRows = 10;
      var totalTr = $("#mfiTable tbody tr").length;
