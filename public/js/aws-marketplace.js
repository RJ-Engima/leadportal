$(document).ready(function () {
  ...
  $("#filtertblData").on("click", function () {
    ...
    $.ajax({
      url: "/aws-marketplace/filterbyDate",
      data: {
...
function dataTablefn() {
  ...
  $(function () {
    var numberOfItems = $("#awsMarketTable tbody tr").length;
    var limitPerPage = 10;
    var totalPages = Math.ceil(numberOfItems / limitPerPage);
    var paginationSize = 5;
    var currentPage;
    var totalRows = $("#awsMarketTable tbody tr").length;
    ...
    function showPage(whichPage) {
      ...
      var maxRows = 10;
      var totalTr = $("#awsMarketTable tbody tr").length;
