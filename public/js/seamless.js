...
function dataTablefn() {
  ...
  $(function () {
    var numberOfItems = $("#seamlessTable tbody tr").length;
    var limitPerPage = 10;
    var totalPages = Math.ceil(numberOfItems / limitPerPage);
    var paginationSize = 5;
    var currentPage;
    var totalRows = $("#seamlessTable tbody tr").length;
    ...
    function showPage(whichPage) {
      ...
      var maxRows = 10;
      var totalTr = $("#seamlessTable tbody tr").length;
