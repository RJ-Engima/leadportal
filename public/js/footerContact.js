$(document).ready(function () {
  ...
  $("#exporttblData").on("click", function () {
    $("#footerContactTbl").tableToCsv({
      fileName: "FooterContactData",
    });
  });
});
...
function dataTablefn() {
  ...
  $(function () {
    var numberOfItems = $("#footerContactTbl tbody tr").length;
    var limitPerPage = 10;
    var totalPages = Math.ceil(numberOfItems / limitPerPage);
    var paginationSize = 5;
    var currentPage;
    var totalRows = $("#footerContactTbl tbody tr").length;
    ...
    function showPage(whichPage) {
      ...
      var maxRows = 10;
      var totalTr = $("#footerContactTbl tbody tr").length;
    ...
    $("#footerContactTbl tbody tr").show();
    showPage(1);
