$(document).ready(function () {
  ...
  $("#categoryPick,#showDate,#fromDt,#toDt").change(function () {
    if (
      (InShow.val() == "today" ||
        InShow.val() == "sevenDay" ||
        InShow.val() == "lstMont") &&
    ...
    if (
      (InShow.val() == "today" ||
        ...
        InShow.val() == "lstMont") &&
      InShow.val() != null &&
      $("#categoryPick").find("option:selected").text() == "All"
  ...
  $("#filtertblData").on("click", function () {
    let selectedOption = $("#showDate").val();
    let categorySelect = $("#categoryPick").val();
    let filterDate;
    let url
    let payLoad = {}
    ...
    if(categorySelect != ""){
      url = "/m2p/whitepapers/filterbyCategory"
    }else{
      url = "/m2p/whitepapers/filterbyDate"
    }
    $("#table-body").html("");
    console.log(categorySelect, "category");

    if(filterDate !== undefined && categorySelect !== undefined ){
      payLoad.startDate = filterDate.split(",")[0],
      payLoad.endDate = filterDate.split(",")[1],
      payLoad.category = categorySelect
    }
    if(filterDate == undefined && categorySelect !== undefined){
      payLoad.category = categorySelect
    }
  ...
  $(".resetMyVal").click(function () {
    ...
    // $("#categoryPick").val('default').selectpicker("refresh");
    $("#showDate").val("default");
    $("#showDate").selectpicker("refresh");
    $("#categoryPick").val("default");
    $("#categoryPick").selectpicker("refresh");
    $("#fromDt").val("");
    $("#toDt").val("");
    $(".DateDiv").hide();
  ...
  $("#exporttblData").on("click", function () {
    $("#whitePapersTbl").tableToCsv({
      fileName: "WhitePapersData",
    });
  });
});
...
function dataTablefn() {
  ...
  $(function () {
    var numberOfItems = $("#whitePapersTbl tbody tr").length;
    var limitPerPage = 10;
    var totalPages = Math.ceil(numberOfItems / limitPerPage);
    var paginationSize = 5;
    var currentPage;
    var totalRows = $("#whitePapersTbl tbody tr").length;
    ...
    function showPage(whichPage) {
      ...
      var maxRows = 10;
      var totalTr = $("#whitePapersTbl tbody tr").length;
